function [esTSNR,esHRNR]=WienerNoiseReduction(ns,fs,IS,SPin,alphaIN)
...
if (nargin<3 | isstruct(IS))
    IS=frames*wl;             %Initial Silence or Noise Only part in samples (= ten frames)
end
...
%% --------- main algorithm ---------------
SP = SPin;      % Shift percentage is 50 % Overlap-Add method works good with this value, //orig .25
normFactor=1/SP;
